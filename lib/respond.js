...
const respond = (request, response) => {
    ...
    try{
        ...
        //Its not a directory but not a file either 
        ...
        //It is a file
            ...
            console.log(`fileDetails.size: ${fileDetails.size}`);
            ...
            getMimeType(fileDetails.extname)
                ...
                if(RegExp('audio').test(mime) || RegExp('video').test(mime)){
                    ...
                    if(range){
                        ...
                        console.log(`start end: ${start_end}`);
